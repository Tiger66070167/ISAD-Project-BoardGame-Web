...
export default class insert<T extends board_game | booking | food_menu | food_order | food_type | table_data | users | booking_period> extends state<T> {
    ...
    makeQuery(stringQuery: string): string {
        ...
        for (let i = 0; i < this.column.length - 1; i++) {
            if (typeof this.column[i] === "number" || 
                typeof this.column[i] === "boolean" ||
                this.column[i] === "default" || 
                this.column[i] === "DEFAULT" || 
                this.column[i] === 'null' || 
                this.column[i] === 'NULL') {
        ...
        if (typeof this.column[this.column.length - 1] === "number" || 
            typeof this.column[this.column.length - 1] === "boolean" ||
            this.column[this.column.length - 1] === "default" || 
            this.column[this.column.length - 1] === "DEFAULT" || 
            this.column[this.column.length - 1] === "null" || 
            this.column[this.column.length - 1] === "NULL") {
