...
export default function Home() {
  return (
    <div>
      <div>
        <div className="bg-[url('../assets/boardgame.jpeg')] bg-cover blur-sm brightness-20 text-white text-center aspect-[16/8.5] place-content-center bg-repeat"></div>
        ...
        <div className="aspect-[16/9] bg-[#111111]"></div>
      </div>
    </div>
  );
}
