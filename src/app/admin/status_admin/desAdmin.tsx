...
export default class desAdmin extends React.Component {
    render() {
        return (
                    ...
                    <div className="shadow-md rounded-lg bg-[#303030] flex flex-col pt-6 w-96 desktop:w-[500px] h-auto pb-20">
                        <div className="grid grid-cols-2">
                            ...
                            <div className="grid grid-cols-2 ml-8">
                                <button className="rounded-lg text-xl bg-[--primary-color] font-bold ml-8 w-32 hover:scale-105 bg-gradient-to-r hover:from-[--primary-color] hover:to-[--accent-color]" type="button">
                                        แก้ไขสถานะ
                                </button>
