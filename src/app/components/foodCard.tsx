...
function foodCard() {
  return (
    <div className="flex w-full shadow-2xl mt-2">
      <div className=" bg-[#292929] hover:bg-[--primary-color] h-[400px] w-full rounded-2xl">
        {/* inbox picture Set */}
        ...
        <div className="ml-9">
          <div className="grid grid-cols-2">
            ...
            {/*  Add button */}
              <button className="flex bg-[--primary-color] w-10 ml-20 rounded-xl text-2xl font-bold"><div className="ml-3 text-[#FFFFFF]">+</div></button>
          </div>
